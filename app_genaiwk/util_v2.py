...
class WebSearchUtil:
    ...
    def create_web_search_query(self, question: str, project: str, location: str="us-central1", profile: str = "", max_query_num: int=5, lang:str="jp", model_name: str=model_gemini_pro25_flash) -> str: 
        """
